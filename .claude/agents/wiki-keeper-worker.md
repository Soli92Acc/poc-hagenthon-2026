...
Worker sub-agent read-only: non scrive in `wiki/` (lo fa il parent wiki-keeper).
Il preflight R.21 è gestito dal parent — questo worker non deve accedere ad
`memory/active-sessions.yaml` autonomamente.
