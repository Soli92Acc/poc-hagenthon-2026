...
**Nessun sub-reviewer ricorsivo**: il fan-out è cap da `code_quality.max_iterations` (default 3, R.Q4); i sub-reviewer non possono spawnare ulteriori reviewer. Max 1 livello di parallelismo.
